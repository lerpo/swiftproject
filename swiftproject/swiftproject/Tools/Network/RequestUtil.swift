...
class RequestUtil: NSObject {
    static let session = Session(eventMonitors: [Logger.monitor])
    static var headers:HTTPHeaders = ["Content-Type": "application/json"]
    static func get(url:String,queryParam:Parameters?=nil,success:@escaping successCallback, fail:@escaping faildCallback)  {
    ...
    static func dowloadFileInPath(url:String,filePath:String,success:@escaping successCallback,
    ...
    static func uploadWithType(type:UploadType,data: Data,formData:[String:String], uploadUrl:URL, filePath:URL,success:@escaping successCallback,fail:@escaping faildCallback){
        switch type {
        case .data:
